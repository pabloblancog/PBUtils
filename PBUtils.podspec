#
#  Be sure to run `pod spec lint PBUtils.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  # Or just: spec.author    = "pabloblancog"
  # spec.authors            = { "pabloblancog" => "pabloblancogonzalez@gmail.com" }
  # spec.social_media_url   = "https://twitter.com/pabloblancog"
